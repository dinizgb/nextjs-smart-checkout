export const notInvitedSection = {
    TITLE: "We're sorry, but you need an invite to see this page :(",
    DESCRIPTION_START: "Get an invite link",
    LINK_TEXT: "here",
    DESCRIPTION_END: ".",
  }
  ...
  export const discountAlerts = {
    SCENARIO_1: "You're taking {NUMBER_OF_ITENS_FOR_FREE} for free! You're saving {VALUE_OF_SAVINGS}.",
    SCENARIO_2: "15% applied to each item you selected! You're saving {VALUE_OF_SAVINGS}.",
    SCENARIO_3:
      "You're taking {NUMBER_OF_ITENS_FOR_FREE} for free! We applied this discount because it's better than the VIP discount.",
  }
  ...
  export const confirmationDialog = {
    TITLE: "It's everything ok with you order?",
    DESCRIPTION: 'Confirm your pickings and hit the "Confirm" to place your order.',
